        ...
        if imgui.BeginChild('Name##'..tab, imgui.ImVec2(), true) then -- [Для декора] Создаём чайлд в который поместим содержимое
            ...
            elseif tab == 3 then -- если значение tab == 3
                ...
                if imgui.Button(u8 'Вызов на связь') then
                    if zk[0] then
                        sampSendChat("/b /d [" .. mainIni.Info.org .. "] з.к [" .. otherdeporg .. "] На связь!")
                    else
                        sampSendChat("/b /d [" .. mainIni.Info.org .. "] 91.8 [" .. otherdeporg .. "] На связь!")
                    end
                end
                if imgui.Button(u8 'Откат') then
                    sampSendChat("/b /d [" .. mainIni.Info.org .. "] 91.8 [Информация] Тех. Неполадки!")
                end
            elseif tab == 4 then
            ...
            elseif tab == 7 then 
                ...
                imgui.Text(u8'Обновление 4.7 - Добавлена Команда /traf')
            end
